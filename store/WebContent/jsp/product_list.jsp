...
<html>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${c.pid}">
					<img src="${pageContext.request.contextPath}/${c.pimage}" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${c.pid}" style='color:green'>${c.pname}</a></p>
				<p><font color="#FF0000">商城价：&yen;${c.market_price}</font></p>
			</div>
			</c:forEach>
		...
		<!-- 引入分页页面 -->
		<%@ include file="/jsp/pageFile1.jsp" %>
		<!--分页 -->
		<!-- 
