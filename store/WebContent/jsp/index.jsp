		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${Hots}" var="c">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${c.pid}">
								<img src="${pageContext.request.contextPath}/${c.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="product_info.html" style='color:#666'>${c.pname}</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${c.shop_price}</font></p>
						</div>
					</c:forEach>
				</div>
			</div>
