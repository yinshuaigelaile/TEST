								...
								<c:forEach items="${list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
												...
												<div id="div${o.oid}" style="display: none">
													<table border="1" width="100%">
														...
														<!--  ajax 显示图片,名称,单价,数量--> 
														<c:forEach items="${o.list}" var="item" varStatus="status">
														<tr>
															<td><img src="${pageContext.request.contextPath}/${item.product.pimage}" width="50px"/></td>
